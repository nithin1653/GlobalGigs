...
export const freelancers: Freelancer[] = [
  {
    ...
    portfolio: [
      { id: 1, title: 'E-commerce Redesign', description: 'Complete overhaul of a major e-commerce platform for an Indian brand.', imageUrl: 'https://placehold.co/600x400.png', hint: 'website design' },
      { id: 2, title: 'Mobile Banking App', description: 'Designed a secure and user-friendly mobile banking application for a leading Indian bank.', imageUrl: 'https://placehold.co/600x400.png', hint: 'mobile app' },
    ],
    experience: [
      { id: 1, role: 'Lead UX Designer', company: 'DigiConnect India', period: '2019 - Present', description: 'Led the design team for flagship products, mentored junior designers, and established a new design system.' },
  ...
  },
  {
    ...
    bio: 'Experienced full-stack developer focused on building scalable and high-performance web applications. I have a strong background in both front-end and back-end technologies, working with top Indian startups.',
    avatarUrl: 'https://placehold.co/128x128.png',
    portfolio: [
    ...
    experience: [
        { id: 1, role: 'Senior Software Engineer', company: 'TechLeap Bangalore', period: '2018 - 2022', description: 'Developed core features for a data analytics platform using React and Node.js.' },
  ...
  },
  {
    ...
    portfolio: [],
    experience: [
        { id: 1, role: 'DevOps Engineer', company: 'InfraScale Delhi', period: '2020 - Present', description: 'Managed cloud infrastructure and CI/CD pipelines for a fast-growing FinTech startup.' },
    ],
  },
  {
    id: '4',
    ...
    bio: 'I help brands tell their stories through compelling content that drives engagement and conversions. Data-driven and creative content strategist with experience in the Indian market.',
    avatarUrl: 'https://placehold.co/128x128.png',
    portfolio: [
    ...
    experience: [
        { id: 1, role: 'Head of Content', company: 'WordWeavers Chennai', period: '2017 - 2021', description: 'Led a team of writers and editors to produce high-quality content for various clients.' },
    ],
  },
  {
    id: '5',
  ...
  },
  {
    ...
    experience: [
      { id: 1, role: 'Senior Mobile Developer', company: 'AppWorks Pune', period: '2019 - 2023', description: 'Led development of several high-profile mobile apps, from concept to launch.' },

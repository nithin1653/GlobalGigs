...
import { Globe, MessageSquare, DollarSign, CheckCircle } from 'lucide-react';
          ...
          <Card className="overflow-hidden text-center bg-background/60 backdrop-blur-xl">
            <CardContent className="p-6">
              ...
              <div className="space-y-2 text-left text-sm text-muted-foreground">
                ...
                <div className="flex items-center"><DollarSign className="w-4 h-4 mr-2 text-primary" /> ${freelancer.rate}/hr</div>
